class DisciplinasController < ApplicationController
  ...
  def index
    @disciplinas = Disciplina.where(habilitado: true)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @disciplina.save
        format.html { redirect_to disciplina_url(@disciplina), notice: "Disciplina foi cadastrada com sucesso." }
  ...
  def update
    respond_to do |format|
      if @disciplina.update(disciplina_params)
        format.html { redirect_to disciplina_url(@disciplina), notice: "Disciplina foi atualizada com sucesso." }
  ...
  def destroy
    ...
    @disciplina.habilitado = false
    @disciplina.save

    respond_to do |format|
      format.html { redirect_to disciplinas_url, notice: "Disciplina foi desabilitada com sucesso." }
  ...
  private
    ...
    def disciplina_params
      params.require(:disciplina).permit(:nome, :codigo, :habilitado)
    end
end
