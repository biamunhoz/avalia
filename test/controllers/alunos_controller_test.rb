...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { habilitado: @aluno.habilitado, numusp: @aluno.numusp } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { habilitado: @aluno.habilitado, numusp: @aluno.numusp } }
