...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post disciplinas_url, params: { disciplina: { codigo: @disciplina.codigo, habilitado: @disciplina.habilitado, nome: @disciplina.nome } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { codigo: @disciplina.codigo, habilitado: @disciplina.habilitado, nome: @disciplina.nome } }
